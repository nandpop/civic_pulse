...
export default function CitizenApp({ triggerRefresh, refreshFlag }) {
  ...
  // Inline styles restored from prototype markup
  const appContainerStyle = {
    ...
    padding: '7px',
    boxShadow: '0 30px 70px -20px rgba(28,33,24,0.55),0 0 0 1px rgba(0,0,0,0.2)',
    animation: 'cpUp .4s ease'
  };
  ...
  return (
    <div style={appContainerStyle}>
      <div style={phoneBodyStyle} className="cpscroll">
        
        {/* Status Bar */}
        <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', padding: '12px 26px 4px', fontSize: '13px', fontWeight: 700, flexShrink: 0 }}>
          <span>9:41</span>
            ...
            <div style={{ padding: '8px 18px 110px' }}>
              ...
              <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', margin: '6px 2px 14px', textAlign: 'left' }}>
                ...
                <button 
                  ...
                  style={{ display: 'flex', alignItems: 'center', gap: '7px', backgroundColor: '#fff', border: '1px solid rgba(30,36,31,0.08)', padding: '6px 11px 6px 7px', borderRadius: '999px', cursor: 'pointer', boxShadow: '0 2px 8px rgba(28,33,24,0.05)' }}
                >
                ...
                {issues.length === 0 ? (
                  ...
                  issues.map((issue) => (
                    <button 
                      ...
                      style={{ textAlign: 'left', backgroundColor: '#fff', border: '1px solid rgba(30,36,31,0.07)', borderRadius: '16px', padding: '13px', cursor: 'pointer', display: 'flex', gap: '12px', alignItems: 'flex-start', boxShadow: '0 2px 10px rgba(28,33,24,0.04)' }}
                    >
            ...
            <div style={{ padding: '8px 18px 120px', textAlign: 'left' }}>
              ...
              <div style={{ display: 'flex', alignItems: 'center', gap: '12px', margin: '4px 0 14px' }}>
                <button 
                  ...
                  style={{ width: '36px', height: '36px', borderRadius: '11px', backgroundColor: '#fff', border: '1px solid rgba(30,36,31,0.08)', display: 'flex', alignItems: 'center', justifyContent: 'center', cursor: 'pointer' }}
                >
                ...
                <div>
                  {!selectedFile ? (
                    <button 
                      ...
                      style={{ width: '100%', border: '2px dashed #BFC6B7', backgroundColor: '#fff', borderRadius: '18px', height: '230px', display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', gap: '12px', cursor: 'pointer' }}
                    >
              ...
              <div style={{ marginTop: '20px' }}>
                {reportStep === 4 ? (
                  <button 
                    ...
                    style={{ width: '100%', backgroundColor: '#1E8A4F', color: '#fff', border: 'none', borderRadius: '14px', padding: '16px', fontSize: '15px', fontWeight: 800, cursor: 'pointer', boxShadow: '0 8px 20px -6px rgba(30,138,79,0.5)', display: 'flex', alignItems: 'center', justifyContent: 'center', gap: '8px' }}
                  >
            ...
            <div style={{ textAlign: 'left', paddingBottom: '100px' }}>
              ...
              <div style={{ position: 'relative', height: '210px', backgroundColor: '#EAE8DE', display: 'flex', alignItems: 'center', justifyContent: 'center', overflow: 'hidden' }}>
                ...
                <button 
                  ...
                  style={{ position: 'absolute', left: '16px', top: '14px', width: '38px', height: '38px', borderRadius: '12px', backgroundColor: 'rgba(255,255,255,0.94)', border: 'none', display: 'flex', alignItems: 'center', justifyContent: 'center', cursor: 'pointer', boxShadow: '0 2px 8px rgba(0,0,0,0.12)' }}
                >
              ...
              <div style={{ padding: '16px 18px 0' }}>
                ...
                {!confirmedMap[selectedIssue.customId] ? (
                  <button 
                    ...
                    style={{ width: '100%', marginTop: '13px', backgroundColor: '#1E8A4F', color: '#fff', border: 'none', borderRadius: '14px', padding: '14px', fontSize: '14px', fontWeight: 800, cursor: 'pointer', display: 'flex', alignItems: 'center', justifyContent: 'center', gap: '8px', boxShadow: '0 6px 16px -6px rgba(30,138,79,0.5)' }}
                  >
                  ...
                  trackedIssues.map((issue) => {
                    ...
                    return (
                      <button 
                        key={issue.customId}
                        onClick={() => openDetail(issue.customId)}
                        style={{ textAlign: 'left', backgroundColor: '#fff', border: '1px solid rgba(30,36,31,0.07)', borderRadius: '16px', padding: '13px', cursor: 'pointer', display: 'flex', flexDirection: 'column', gap: '12px', boxShadow: '0 2px 10px rgba(28,33,24,0.04)' }}
                      >
        ...
        {screen === 'map' && (
          <div style={{ position: 'relative', width: '100%', height: '100%', display: 'flex', flexDirection: 'column', backgroundColor: '#F6F4ED', animation: 'cpFadeIn .3s ease' }}>
            ...
            <div style={{ flex: 1, position: 'relative' }}>
              ...
              <div style={{ position: 'absolute', bottom: '24px', left: '20px', right: '20px', display: 'flex', justifyContent: 'center' }}>
                <div style={{ backgroundColor: '#fff', borderRadius: '24px', padding: '12px 24px', display: 'flex', gap: '8px', alignItems: 'center', boxShadow: '0 10px 25px rgba(28,33,24,0.1)' }}>
        ...
        {/* Tab Navigation Bar */}
        {screen !== 'report' && (
          <div style={{ position: 'absolute', left: 0, right: 0, bottom: 0, height: '84px', backgroundColor: 'rgba(255,255,255,0.92)', backdropFilter: 'blur(14px)', borderTop: '1px solid rgba(30,36,31,0.07)', display: 'flex', alignItems: 'center', justifyContent: 'space-around', padding: '0 14px 14px' }}>
            <button 
              onClick={() => setScreen('home')}
        ...
        {/* Global Toast */}
        {toast && (
          <div className="animate-toast" style={{ position: 'fixed', left: '50%', bottom: '26px', transform: 'translateX(-50%)', backgroundColor: '#16130E', color: '#fff', padding: '13px 18px', borderRadius: '13px', fontSize: '13px', fontWeight: 700, display: 'flex', alignItems: 'center', gap: '9px', boxShadow: '0 14px 34px -8px rgba(0,0,0,0.5)', zIndex: 50 }}>
        ...
        {selectedBadge && (
          <div 
            ...
            style={{ position: 'absolute', top: 0, left: 0, right: 0, bottom: 0, backgroundColor: 'rgba(22,19,14,0.6)', display: 'flex', alignItems: 'center', justifyContent: 'center', zIndex: 100 }}
          >
            <div 
            ...
            >
              ...
              <button 
                onClick={() => setSelectedBadge(null)}
                style={{ width: '100%', marginTop: '20px', backgroundColor: '#1E8A4F', color: '#fff', border: 'none', borderRadius: '12px', padding: '12px', fontSize: '14px', fontWeight: 800, cursor: 'pointer', boxShadow: '0 4px 12px rgba(30,138,79,0.3)' }}
              >
                Awesome
              </button>
            </div>
